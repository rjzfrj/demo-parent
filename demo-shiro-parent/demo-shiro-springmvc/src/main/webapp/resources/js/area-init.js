...
//定义 银行 数据数组
bankArray = new Array("北京银行","北京农商银行","中国光大银行","浙商银行","东亚银行","华夏银行","杭州银行","宁波银行","南京银行","中国邮政储蓄银行","深圳发展银行","中国银行","中国建设银行","中国农业银行","中国工商银行","交通银行","招商银行","浦发银行","广发银行","中国民生银行","兴业银行","中信银行","平安银行");

function getBank() {
    //得到 当前省 市
    for (var i = 0; i < bankArray.length; i++) {
        //填充 城市 下拉选单
        document.getElementById("bank_address").options[i+1] = new Option(bankArray[i], bankArray[i]);
    }
}
...
function getBankModify(bank) {
    ...
    for (var i = 0; i < bankArray.length; i++) {
        ...
        //填充 城市 下拉选单
        document.getElementById("bank_address").options[i+1] = option;
    }
}
...
function getProvince() {
    ...
    for (var i = 0; i < provinceArray.length; i++) {
        //填充 城市 下拉选单
        document.getElementById("bankProvince1").options[i+1] = new Option(provinceArray[i], provinceArray[i]);
    }
}
...
function getCity(currProvince) {
    ...
    var i, j, k;
    //清空 城市 下拉选单
    document.all.bankCity.length = 0;
    for (var i = 0; i < cityArray.length; i++) {
        ...
        if (cityArray[i][0] == currProvince) {
            ...
            for (j = 0; j < tmpcityArray.length; j++) {
                //填充 城市 下拉选单
                document.getElementById("bankCity").options[j] = new Option(tmpcityArray[j], tmpcityArray[j]);
            }
        }
    }
}
...
function getProvinceModify(province) {
    ...
    for (var i = 0; i < provinceArray.length; i++) {
        ...
        //填充 城市 下拉选单
        document.getElementById("bankProvince1").options[i+1] = option;
    }
}
...
function getCityModify(currProvince,city) {
    ...
    var i, j, k;
    //清空 城市 下拉选单
    document.getElementById("bankCity1").length = 0;
    for (i = 0; i < cityArray.length; i++) {
        //得到 当前省 在 城市数组中的位置
        if (cityArray[i][0] == currProvince) {
            //得到 当前省 所辖制的 地市
            ...
            for (j = 0; j < tmpcityArray.length; j++) {
                ...
                //填充 城市 下拉选单
                document.getElementById("bankCity1").options[j] = option;
            }
        }
    }
}
