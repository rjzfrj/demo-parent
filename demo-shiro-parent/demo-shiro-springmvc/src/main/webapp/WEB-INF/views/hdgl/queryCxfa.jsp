...
$('#userTable').datagrid({
			...
			columns:[[
				...
				{field:'rule',title:'优惠方案',width:30,sortable:true,
					formatter:function(value,row,index){
						return row.rule;  
					}
				},
				{field:'type',title:'促销方案类型',width:30,sortable:true,
					formatter:function(value,row,index){
					    var s="";
					    if(row.type=="00")
					      s="充值";
				...
				{field:'valid_date',title:'有效期(天)',width:30,sortable:true,
					formatter:function(value,row,index){
						return row.valid_date;  
					}
				},
				{field:'start_time',title:'生效日期',width:30,sortable:true,
					formatter:function(value,row,index){
						return row.start_time; 
					}
				},
				{field:'operator',title:'明细',sortable:true,
					formatter:function(value,row,index){
					var i = '<a href="javascript:void(0)" onclick="detailInfo(\''+row.id+'\')">详细</a>';
				    return i;  
					}
				}
			]],
...
<form id="queryForm">
   <div class="title_right"><strong>查看促销方案</strong></div>  
     ...
     <table class="table table-bordered">
	     ...
	     <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">促销方案类型：</td>
         <td><select id="type" name="type" style="height:25px">
